      ...
      <div class="row"> 
        ...
        <div class="col-md-10 col-md-offset-1">
          ...
          <h1 class="white-text">Welcome To</h1>
            <h1 class="white-text" >Innov8ive Knowl-age Worx</h1>
            <p class="white-text" style="color:white">Be Phenomenal </p>
          </div>
        </div>
        <!-- /home content --> 
...
Block 5</p>
      ...
      <div class="col-md-8 col-md-offset-2">
        <form action="" method="post">
          ...
          <input type="submit" style="background-color:#267FC0; color:#1FE95C" name="submit" value="Send Message">
        </form>
      </div>
      <!-- /contact form --> 
